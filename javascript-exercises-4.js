...
function exerciseOne(value){ 
  let value2 = true; 
// In this exercise, you will be given a variable, it will be called: value 
// On line 19 create a variable called 'andOperator' // Using the logical operators assign it to whether BOTH value AND value2 are true; 
  let andOperator = value && value2 === true;
  
  return andOperator;
}

function exerciseTwo(value){ let value2 = false;
// In this exercise, you will be given a variable, it will be called: value
// On line 28 create a variable called 'orOperator' 
